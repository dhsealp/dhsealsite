...
<html>
  <head>
    ...
    <title>DHS-A2|Donghai Sealant</title>
...
<H1 class=page_title>DHS-A2 | Acetoxy Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="./csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsa2z.png" rel=gal1><IMG title="" 
alt="" src="./csd/dhsa2.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsa2.png',largeimage: './csd/dhsa2.png'}"><IMG 
  alt="" src="./csd/dhsa2.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-A2 Acetoxy Silicone Sealant is for common windows and doors 
fixing,one-component,good capability of bonding.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-A2 Acetoxy Silicone Sealant.&nbsp;</P>
<P>For common windows and doors fixing,one-component,good capability of 
bonding.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>DHS-A2 series are in single component, acid, room curing.</LI>
  <LI>Fast curing speed and &nbsp;superior&nbsp;bonding&nbsp;strength.</LI>
  <LI>Good flexibility,multi-use,convenient to apply.</LI>
  <LI>Excellent&nbsp; bonding&nbsp;ability on&nbsp;most basic 
  materials,and&nbsp;good&nbsp;durability.</LI>
  <LI>Well weathering and aging resistance.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>All kinds of doors and windows installations.</LI>
  <LI>For the sealing 
  and&nbsp;assembling&nbsp;of&nbsp;various&nbsp;industrial&nbsp;works.</LI>
  <LI>Other industrial uses and family&nbsp;decoration.</LI></UL>
<H4>Restrictions:</H4>
<UL>
...
<H4>Packaging:</H4>
<UL>
  <LI>Cartridge, 300ml(net&nbsp;&nbsp;capacity),&nbsp;24 pieces per 
  carton.&nbsp;&nbsp;</LI></UL>
<H4>Storage:</H4>
<UL>
  <LI>It should be stored in a dry,cool and well&nbsp;ventilated place, where 
  the temperature is below 27&nbsp;centigrade.As from the date of production,the 
