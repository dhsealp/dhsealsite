...
<html>
  <head>
    ...
    <title>DHS-DB|Donghai Sealant</title>
...
<H1 class=page_title>DHS-DB | Two-component</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsdbz.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsdb.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsdb.png',largeimage: './csd/dhsdb.png'}"><IMG 
  alt="" src="csd/dhsdb.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-DB Two Component Silicone Glass Sealant, neutral, high modulus,special 
for hollow and insulated glass.&nbsp;</P>
<DIV class=ava_price>
...
<UL>
  <LI>Two components, neutral ,room curing,especially&nbsp;used for&nbsp;double 
  course glass.</LI>
  <LI>High strength, low ventilation ratio. It perfoms good&nbsp;adhesive 
  ability&nbsp;to different glasses.</LI>
  <LI>After curing into a elastic solid, it has&nbsp;superior 
  weatherability,&nbsp;aging/wet/UV resistance.</LI>
  <LI>Good consistency with other neutral silicone sealants.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>When using, A and B should be mixed&nbsp;together&nbsp;evenly with the 
  proportion of A:B=10:1(BY VOLUME) or A:B=12:1(BY WEIGHT).</LI>
  <LI>For the second sealing of hollow glass.</LI>
  <LI>Can be&nbsp;used to other things according to actual&nbsp;needs.</LI></UL>
<H4>Restrictions:</H4>
<UL>
  <LI>Can not be used as structural adhesive.</LI>
  <LI>Not suitable for the materials surface&nbsp;with grease&nbsp;seep,&nbsp; 
  plasticizing&nbsp;agent or other liquid organic.</LI>
  <LI>Not suitable for long-term&nbsp;underground joints and&nbsp;soaking 
  places.</LI></UL>
<H4>Packaging:</H4>
<UL>
  <LI>A-component (base adhesive): Iron&nbsp;Drum (net capacity:&nbsp;200L)</LI>
  <LI>B-component (curing agent):Plastic&nbsp; Barrel (net 
  capacity:30L)&nbsp;&nbsp;</LI></UL>
<H4>Storage:</H4>
<UL>
  <LI>It&nbsp; should be stored in a dry, cool and well ventilated place, 
  where&nbsp;the temperature is below 27&nbsp;centigrade. As from the date of 
  production,the storage period is 12&nbsp;months.</LI></UL>
<UL></UL>
