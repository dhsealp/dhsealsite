...
String img=basePath+"csd/dhsa1z.png";
%>
...
<html>
  <head>
    ...
    <title>DHS-A1|Donghai Sealant</title>
...
type=text/css href="csd/grid.css" media=screen><LINK 
rel=stylesheet type=text/css href="csd/jquery.jqzoom.css">
...
<DIV class=grid_6>
<UL id=cart_nav>
  <LI><A class=cart_li >Call us: +86 133 
...
<H1 class=page_title>DHS-A1 | Acetoxy Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" href="<%=img%>" rel=gal1><IMG title="" 
alt="" src="csd/dhsa1.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsa1.png',largeimage: './csd/dhsa1.png'}"><IMG 
  alt="" src="csd/dhsa1.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-A1 Acetoxy Silicone Sealant is for multi-purpose uses,suit to 
glass,ceramic and aluminum parts etc sealing. </P>
<DIV class=ava_price>
...
<P>DHS-A1 Acetoxy Silicone Sealant</P>
<P>For multi-purpose uses,suit to glass,ceramic and aluminum parts etc sealing. 
</P>
...
<H4>Applications:</H4>
<UL>
  <LI>For&nbsp;bonding and&nbsp;sealing of glass,aluminum &nbsp;and&nbsp;ceramic 
  materials etc.</LI>
  <LI>For the installation of windows and doors.</LI>
  <LI>For various sanitary&nbsp;assembling.</LI></UL>
<H4>Restrictions:</H4>
<UL>
