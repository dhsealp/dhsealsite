...
<DIV class=grid_6>
<UL id=cart_nav>
  <LI><A class=cart_li href="http://www.dhseal.com/catalog_grid_neu.html#">Call 
...
class=current>Neutral silicone sealant</SPAN> </DIV><!-- .breadcrumbs --></DIV><!-- .grid_12 --></DIV><!-- .container_12 -->
