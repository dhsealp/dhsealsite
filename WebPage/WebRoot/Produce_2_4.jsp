...
<html>
  <head>
    ...
    <title>DHS-NC1|Donghai Sealant</title>
...
<H1 class=page_title>DHS-NC1 | Neutral Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsnc1z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsnc1.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsnc1.png',largeimage: './csd/dhsnc1.png'}"><IMG 
  alt="" src="csd/dhsnc1.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-NC1 Neutral Building Silicone Sealant is good performance of weatherproof 
and age resistance,well applied to major project.</P>
<DIV class=ava_price>
...
<P>DHS-NC1 Neutral Building Silicone Sealant.&nbsp;</P>
<P>Good performance of weatherproof and age resistance,well applied to major 
project.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>One&nbsp;component, neutral, room curing, can be used under wide weather 
  conditions.</LI>
  <LI>Fast curing speed, having&nbsp;excellent&nbsp; bonding capacity to many 
  kinds of&nbsp; base materials.</LI>
  <LI>Having weather and age resistant&nbsp;performance, ideal sealant&nbsp; for 
  common&nbsp;weathering sealing. </LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>For installation and sealing of various windows and doors.</LI>
  <LI>For gap filling&nbsp;and bonding of glass members, 
  weatherproofing&nbsp;sealing of&nbsp; many materials like concrete,aluminum 
  panels,etc.</LI>
  <LI>Most of the materials sealing,and other multi-purpose assembly.</LI></UL>
<H4>Restrictions:</H4>
<UL>
  <LI>Cannot be used as silicone structural sealant.</LI>
  <LI>Not suitable for the material surface with grease&nbsp;seep, plasticizing 
  agent or solvent.</LI>
  <LI>Not suitable to use in non-ventilated place,it needs moisture in air 
  to&nbsp;solidify.</LI>
  <LI>Not suitable for frosting and wet surface.</LI>
...
<H4>Storage:</H4>
<UL>
  <LI>It should be stored in a dry, cool and well&nbsp;ventilated 
  place,&nbsp;where the temperature is below 27. From the date of production, 
  the storage period is 12&nbsp;months.</LI></UL>
<H4>Joint Size:</H4>
<TABLE>
  <TBODY>
  <TR>
