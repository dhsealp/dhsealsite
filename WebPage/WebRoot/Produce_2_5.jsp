...
<html>
  <head>
    ...
    <title>DHS-NC2|Donghai Sealant</title>
...
href="http://www.dhseal.com/index.html">Home</A><SPAN>›</SPAN><A 
href="">Category</A><SPAN>›</SPAN><SPAN 
class=current>DHS-NC2</SPAN> 
...
<H1 class=page_title>DHS-NC2 | Neutral Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsnc2z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsnc2.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsnc2.png',largeimage: './csd/dhsnc2.png'}"><IMG 
  alt="" src="csd/dhsnc2.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-NC2 Silicone Weatherability Silicone Sealant is superior resistance 
properties of weathering and aging, widely used.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-NC2 Silicone Weatherability Silicone Sealant.&nbsp;</P>
<P>Superior resistance properties of weathering and aging, widely 
used.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>Single component, neutral, room curing, high modulus,&nbsp;fast curing 
  speed.</LI>
  <LI>High bonding&nbsp;strength, non-corrosive, have a strong seal with the 
  majority of construction materials.</LI>
  <LI>Good adhesive capacity on many base materials, having&nbsp; excellent 
  weatherability and aging resisance.</LI>
  <LI>After curing, formed a good material with&nbsp;ozone resistance,UV, 
  rainwater&nbsp;resistance.</LI>
  <LI>Good compatibility with 
  other&nbsp;neutral&nbsp;silicone&nbsp;sealants.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>For weatherproofing sealing of various&nbsp;glass, aluminum plate,ceramic 
  and curtain wall.</LI>
  <LI>For joint cohesion and filling&nbsp;of marble, concrete, metal plate.</LI>
  <LI>Other building or industrial functions.</LI></UL>
<H4>Restrictions:</H4>
<UL>
  <LI>Cannot be used as silicone structural&nbsp;sealant.</LI>
  <LI>Not suitable for the materials surface&nbsp; with grease 
  seep,plasticizing&nbsp; agent or solvent.</LI>
  <LI>Not suitable to use in non-ventilated place,it needs moisture in air 
  to&nbsp;solidify.</LI>
  <LI>Not suitable for the continuous soggy places or&nbsp;wet places all the 
  year&nbsp;round.</LI>
  <LI>Not suitable&nbsp;to use when the temperature&nbsp;of the materials 
  surface is lower than 4 centigrade or higher than 40&nbsp;centigrade.</LI></UL>
<H4>Packaging:</H4>
<UL>
  <LI>Cartridge, 260ml, 280ml, 300ml(net capacity),24 pieces 
  per&nbsp;carton.&nbsp;</LI></UL>
<H4>Storage:</H4>
<UL>
