...
<html>
  <head>
    ...
    <title>DHS-NC3|Donghai Sealant</title>
...
<H1 class=page_title>DHS-NC3 | Neutral Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsnc3z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsnc3.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsnc3.png',largeimage: './csd/dhsnc3.png'}"><IMG 
  alt="" src="csd/dhsnc3.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-NC3 Silicone Structural Sealant is top grade Silicone Structural Sealant, 
high-strength,mainly used for structural assembling.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-NC3 Silicone Structural Sealant.&nbsp;</P>
<P>Top grade Silicone Structural Sealant, high-strength,mainly used for 
structural assembling.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>Excellent adhesive ability&nbsp; to many kinds of&nbsp;base materials, in 
  single component,neutral,room curing,non-corrosive to metal,coating 
  glass,and&nbsp;marble.</LI>
  <LI>2.Superior high and low&nbsp;temperature endurances, the performance 
  changes little within the degree -40 to 150.</LI>
  <LI>Good compatibility with other neutral&nbsp;silicone&nbsp;sealants.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>Structural bonding and sealing on glass,stone and&nbsp;aluminum curtain 
  walls,as well as other metal construction projects.</LI>
  <LI>Weathering cementation and seal of various glass curtain walls 
joints.</LI>
  <LI>The second time bonding and&nbsp;sealing on&nbsp;&nbsp;hollow glass.</LI>
  <LI>For various kinds of building and industrial&nbsp;sealing.</LI></UL>
<H4>Restrictions:</H4>
<UL>
  <LI>Not suitable for the materials surface with&nbsp;grease seep, plasticizing 
  agent or solvent.</LI>
  <LI>Not suitable to use in non-ventilated place, &nbsp;it needs moisture in 
  air to&nbsp;solidify.</LI>
