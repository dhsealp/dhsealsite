...
<html>
  <head>
    ...
    <title>DHS-A|Donghai Sealant</title>
...
href="">Category</A><SPAN>›</SPAN><SPAN 
class=current>DHS-A</SPAN> 
...
<H1 class=page_title>DHS-A | Acylic Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsaz.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsa.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsa.png',largeimage: './csd/dhsa.png'}"><IMG 
  alt="" src="csd/dhsa.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-A Acrylic Sealant is Paintable &amp; Water based, for Exterior or 
Interior use,&nbsp;and excellent in Fire resistant.</P>
<DIV class=ava_price>
...
<P>DHS-A Acrylic Sealant</P>
<P>For multi-purpose uses,suit to glass,ceramic and aluminum parts etc 
sealing.</P>
<H4>Characteristics:</H4>
<UL>
  <LI>Paintable &amp; Water based.&nbsp;</LI>
  <LI>Fireproof.</LI>
  <LI>Water based one component and easy to use.</LI>
  <LI>Excellent sealing performance,smoke blocking.</LI>
  <LI>Excellent fire resistance capacity.</LI>
  <LI>No smell.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>Sealing exterior and interior construction joints.</LI>
  <LI>Small plaster repairs before painting.</LI>
  <LI>Connecting joints in plasterboard technology.</LI>
  <LI>Sealing around window and door frames.</LI>
  <LI>Sealing of aerated concrete.</LI>
  <LI>Excellent for caulking around concrete panels,blockwork,brickworks,gaps 
  around cables,metal pipes,conduits,busways and ducts that penetrate 
  walls,floors and ceilings.</LI></UL>
<H4>Restrictions:</H4>
<UL>
  <LI>Surface must be dry, clean and free from dirt oils, stains or other 
  surface contaminants. Remove all loose materials.</LI>
  <LI>Always use a standard caulking gun to dispense the sealant.</LI>
  <LI>Ensure that sealant is in contact with both sides of joints and gaps. Use 
  foam backer rods as necessary.</LI>
  <LI>Remove excess sealants and smooth with flat knife. Applied sealant is 
  touch-dry after 30 min. Protect from water exposure for at least 4 hours after 
  application. Can be painted over after 2 hours.</LI></UL>
<H4>Packaging:</H4>
<UL>
  <LI>Cartridge:280ml, 300ml, 310ml;Sausage:600ml;Drum: 200L drum</LI></UL>
<H4>Storage:</H4>
<UL>
  <LI>Protecting from freezing;store in a cool,dry place at room temperature.12 
  months guarantee.</LI></UL>
<H4>Joint Size:</H4>
<TABLE>
  <TBODY>
  <TR>
