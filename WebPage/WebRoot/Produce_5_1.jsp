...
<html>
  <head>
    ...
    <title>DHS-G|Donghai Sealant</title>
...
<H1 class=page_title>DHS-G | Gasket Maker</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsagz.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsag.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsag.png',largeimage: './csd/dhsag.png'}"><IMG 
  alt="" src="csd/dhsag.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-G Silicone Sealant is Siliconized gasket maker, resistant to 
oil,water,high temperature, Exemption mat glue.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-G Silicone Sealant.&nbsp;</P>
<P>Siliconized gasket maker.&nbsp;</P>
<P>Resistant to oil,water,high temperature.&nbsp;</P>
<P>Exemption mat glue.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>One component,siliconized sealant adhesive.</LI>
  <LI>It can replace the traditional solid gasket and seal ring.It is applied on 
  flat sealing for mechanism, car, motorbike, tractor.</LI>
  <LI>For electromechanical equipment,electrical 
  equipment,instrument,electronics and chemical equipment etc.</LI>
  <LI>Connect sealing for pipe adapter,engine and plug screw,with excellent stop 
  leaking and sealing effect to water,gas and oil.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>It is widely used in sealing for the surface of engine,gear case, car 
  engine,motorcycles,ships and face flange,pipe joint and vover plate of 
  engineering machinery.</LI>
  <LI>Chemical equipment,pipe and water pump,instrument,electronics industry, 
  appliance and othre mechanical equipment.</LI></UL>
<H4>Advantages:</H4>
<UL>
  <LI>High&nbsp;sealing&nbsp;strength.</LI>
  <LI>High&nbsp;temperature&nbsp;and&nbsp;weather&nbsp;resistance.</LI>
  <LI>No&nbsp;smell&nbsp;and&nbsp;no&nbsp;sagging.</LI>
  <LI>Good&nbsp;oil&nbsp;resistance.</LI>
  <LI>Nontoxic&nbsp;and&nbsp;environmentally&nbsp;friendly.</LI></UL>
<H4>Packaging:</H4>
<UL>
  <LI>85g/tube;12tubes/small&nbsp;box;&nbsp;144tubes/cartons.</LI>
  <LI>Size:64.5*43*28cm</LI></UL>
<H4>Storage:</H4>
<UL>
  <LI>It should be stored in a dry, cool and well ventilated place,where the 
  temperature is below 27 centigrade.As from the date of production,the storage 
  period is&nbsp;12&nbsp; months.</LI></UL>
