...
<html>
  <head>
    ...
    <title>DHS-NT2|Donghai Sealant</title>
...
<H1 class=page_title>DHS-NT2 | Neutral Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsnt2z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsnt2.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsnt2.png',largeimage: './csd/dhsnt2.png'}"><IMG 
  alt="" src="csd/dhsnt2.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-NT2 Neutral Transparent Silicone Sealant is with excellent properties of 
age and weather resistance,well applied for construction.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-NT2 Neutral Transparent Silicone Sealant.</P>
<P>With excellent properties of age and weather resistance,well applied for 
construction.&nbsp;</P>
<H4>Characteristics:</H4>
<UL>
  <LI>One component,neutral,room curing, and of high quality.</LI>
  <LI>Good bonding capacity on most basic materials，fast curing speed.</LI>
  <LI>Superior performance of weather and aging&nbsp; resistance,and it changes 
  little within the range&nbsp; between -40 celsius and 150&nbsp;celsius.</LI>
  <LI>Can be well bonding with most construction materials without primer.</LI>
  <LI>Excellent compatibility with other neutral silicone sealant.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>For the joint&nbsp;sealing of concrete,glass,marble,aluminum plate 
  and&nbsp; metal &nbsp;members,etc.</LI>
  <LI>For indoor and outdoor&nbsp;decoration.</LI>
  <LI>For cohesion and sealing&nbsp;of most building materials such as 
  aluminum,steel,ceramic,plastic,aluminum panels,etc.</LI>
  <LI>The final&nbsp;decoration sealing of&nbsp;assembling&nbsp;works.</LI></UL>
<H4>Restrictions:</H4>
<UL>
...
<UL>
  ...
  <LI><A >FAQ</A></LI>
  <LI><A >Site Map</A></LI>
  </UL></NAV><!-- .private --></DIV><!-- .grid_3 --><DIV class=clear></DIV></DIV><!-- .container_12 --></DIV><!-- .f_navigation -->
<DIV class=f_info>
<DIV class=container_12>
<DIV class=grid_6>
