...
<html>
  <head>
    ...
    <title>DHS-A3|Donghai Sealant</title>
...
<H1 id=site_logo><A title="" href="http://www.dhseal.com/index.html"><IMG 
...
<H1 class=page_title>DHS-A3 | Acetoxy Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsa3z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsa3.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsa3.png',largeimage: './csd/dhsa3.png'}"><IMG 
  alt="" src="csd/dhsa3.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-A3 Acetoxy Silicone Structural Sealant is top grade acid sealant for 
structural assembling of various curtain walls.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-A3 Acetoxy Silicone Structural Sealant.</P>
<P>Top grade acid sealant for structural assembling of various curtain 
walls.</P>
<H4>Characteristics:</H4>
<UL>
  <LI>Single component , fast cured at room temperature.</LI>
  <LI>Good flexibility,high strength,convenient to use.</LI>
  <LI>Having superior performance&nbsp;of&nbsp;weather and aging 
  &nbsp;resistance, long working life.</LI>
  <LI>With high&nbsp;modulus property&nbsp;after cured, +/-30% 
  joint&nbsp;movement&nbsp;capability.</LI></UL>
<H4>Applications:</H4>
<UL>
  <LI>Applying&nbsp; to structural sealing&nbsp;and assembling glass in various 
  curtain walls.</LI>
  <LI>For filling and&nbsp;bonding&nbsp;of different 
  glass&nbsp;assembling&nbsp;projects.</LI></UL>
<H4>Restrictions:</H4>
<UL>
