...
<html>
  <head>
    ...
    <title>DHS-NT3|Donghai Sealant</title>
...
<H1 class=page_title>DHS-NT3 | Neutral Silicone Sealant</H1>
<DIV class=product_page>
<DIV id=products class="grid_4 img_slid"><IMG class=sale alt=Sale 
src="csd/sale.png"> 
<DIV class="preview slides_container">
<DIV class=prev_bg><A class=jqzoom title="" 
href="./csd/dhsnt3z.png" rel=gal1><IMG title="" 
alt="" src="csd/dhsnt3.png"> </A></DIV></DIV><!-- .prev -->
<UL id=thumblist class="pagination clearfix">
  <LI><A class=zoomThumbActive href="javascript:void(0);" 
  rel="{gallery: 'gal1', smallimage: './csd/dhsnt3.png',largeimage: './csd/dhsnt3.png'}"><IMG 
  alt="" src="csd/dhsnt3.png"></A></LI></UL></DIV><!-- .grid_4 -->
<DIV class=grid_5>
<DIV class=entry_content>
<P>DHS-NT3 Neutral Transparent Silicone Sealant is top grade Silicone Structural 
Sealant, high-strength, mainly used for structural assembling.&nbsp;</P>
<DIV class=ava_price>
...
<P>DHS-NT3 Neutral Transparent Silicone Sealant.</P>
...
<UL>
  ...
  glass,and&nbsp;marble.</LI>
  <LI>One&nbsp;component, neutral , room&nbsp;curing ,can be used under wide 
  weather conditions.</LI>
  <LI>Superior high and low &nbsp;temperature endurances, the performance 
  changes little within the degree -40 to 150.</LI></UL>
<H4>Applications:</H4>
<UL>
